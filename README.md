...
|---|---|---|
| [session](docs/en/session.md) | `Cmd+Shift+S` | Browse and manage Claude Code sessions — resume, fork, continue, new session, git worktree, transcript preview, rename, and live activity (which sessions are running right now). |
