...
лежат независимые репозитории (~/work с api, web, infra). Здесь
...
# Глубина скана подпапок: покрывает и ~/work/api, и папку с
# группировкой по клиентам (work/client-a/api). Глубже начинается
