"""Git-слой log-кита: история коммитов и работа с удалёнками.

Тонкие обёртки над общими примитивами из modules.vcs.git: `git log`
для списка, ref-метки, fetch/push. Изменения самого коммита —
в modules.vcs.commit (их показывает общий вьюер). Без TUI.
"""

from ..vcs.git import run_git, run_git_err
